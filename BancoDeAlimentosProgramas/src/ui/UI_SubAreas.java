 ...
 */
public class UI_SubAreas extends javax.swing.JFrame {

    /**
     * Creates new form UI_SubAreas1
     */
    public UI_SubAreas() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_SubAreas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UI_SubAreas().setVisible(true);
            }
        });
    }
