...
import com.caritas.facade.ProveedoresFacade;
...
public class ProveedoresController implements Serializable {
    ...
    @EJB
    private com.caritas.facade.ProveedoresFacade ejbFacade;
    ...
    public static class ProveedoresControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Proveedores) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + ProveedoresController.class.getName());
            }
        }
    }
}
