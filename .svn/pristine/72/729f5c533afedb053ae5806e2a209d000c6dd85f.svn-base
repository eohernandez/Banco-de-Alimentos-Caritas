...
import com.caritas.facade.UnidadFacade;
...
public class UnidadController implements Serializable {
    ...
    @EJB
    private com.caritas.facade.UnidadFacade ejbFacade;
    ...
    public static class UnidadControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Unidad) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + UnidadController.class.getName());
            }
        }
    }

    @ManagedBean(name = "unidadCompleter")
    @ApplicationScoped
    public static class UnidadCompleter {
        @EJB
        private UnidadFacade donantes;
