...
import com.caritas.facade.ProgramasFacade;
...
public class ProgramasController implements Serializable {
    ...
    @EJB
    private com.caritas.facade.ProgramasFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ProgramasCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ProgramasUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ProgramasDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    @ManagedBean(name = "programasCompleter")
    @ApplicationScoped
    public static class ProgramasCompleter {

        @EJB
        private transient ProgramasFacade programas;
        @ManagedProperty("#{parametersController.suggestionLength}")
        private int suggestionsLength;

        public List<Programas> complete(String query) {
            return programas.findLike(query, suggestionsLength);
        }
